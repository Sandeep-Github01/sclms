...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\laravel\sclms\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\laravel\\sclms\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'admin.user.index','admin.user.show','admin.user.destroy','login',
'frontend.user.login','frontend.user.loginMatch','frontend.user.logout','frontend.user.register','frontend.user.registerSave',
'frontend.emails.verificationSent','frontend.emails.verify-email','frontend.user.profile','frontend.user.dashboard',
'leave.create','leave.store','leave.list','leave.show','leave.result',
'storage.local',);
        registerArgumentsSet('views', 
'backend.partials.footer','backend.partials.header','backend.partials.sidebar','backend.user.index','backend.user.show',
'frontend.dashboard','frontend.emails.verificationSent','frontend.emails.verify-email','frontend.leave.apply','frontend.leave.list',
'frontend.leave.result','frontend.leave.show','frontend.partials.footer','frontend.partials.header','frontend.partials.sidebar',
'frontend.user.login','frontend.user.profile','frontend.user.register','welcome','laravel-exceptions-renderer::components.card',
...
'APP_MAINTENANCE_STORE','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK',
