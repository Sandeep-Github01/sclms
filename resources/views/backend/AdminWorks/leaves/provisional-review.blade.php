...
<div class="main-content">
    <div class="user-detail-card">
        <h2>Review Provisional Document</h2>
        ...
        <div class="review-container">
            ...
            <div class="leave-details">
                ...
                <div class="detail-section">
                    ...
                    <p><strong>Status:</strong> Provisional – Document Uploaded</p>
                </div>
                ...
                @if($leave->file_path)
                    ...
                    <hr><br>
                    <div class="detail-section">
                        <h3>Uploaded Medical Document</h3>
                        <p>
                        ...
                        <div class="recent-leaves">
                            @foreach($recentLeaves as $recent)
                                <div class="recent-item">
                                    ...
                                    <p class="recent-dates">
                                        {{ $recent->start_date->format('Y-m-d') }} to
        ...
        <div class="decision-form">
            ...
            <br>
            <hr>
            <a href="{{ route('admin.leaves.provisional-index') }}" class="btn-back">Back to List</a>
        </div>
    </div>
</div>
